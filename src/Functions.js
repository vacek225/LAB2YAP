// 1. Функция вычисления разности двух чисел (оба способа)
...
// 2. Функция для приветствия по возрасту
function greet(age) {
    if (age < 18) {
...
// 3. Функция, возвращающая наибольшее из трех чисел
